...
.GLOBAL sc_ReadSector,sc_WriteSector,sc_InitSCMode,sc_MemoryCard_IsInserted,sc_write_sdram,sc_read_sdram,sc_rumble_Inserted,sc_rumble_flash_Erase,sc_rumble_flash_write
@extern "C" void sc_ReadSector (u16 *buff,u32 sector,u8 readnum);
@extern "C" void sc_WriteSector (u16 *buff,u32 sector,u8 writenum);
@extern "C" void sc_InitSCMode (void);
@extern "C" bool sc_MemoryCard_IsInserted (void);

@extern "C" void sc_write_sdram (u16 *s,u16 *d,int num);
@extern "C" void sc_read_sdram (u16 *s,u16 *d,int num);

@extern "C" bool sc_rumble_Inserted (void);
@extern "C" bool sc_rumble_flash_Erase (u16* flash_address);
@extern "C" bool sc_rumble_flash_write (u16* flash_address,u16 data);
...
@----------void sc_ReadSector(u16 *buff,u32 sector,u8 readnum)-------------
		.ALIGN
...
@---------------void sc_WriteSector(u16 *buff,u32 sector,u8 writenum)---------------------
		.ALIGN
...
@-----------------void sc_write_sdram(u16 *s,u16 *d,int num)-----not support rumble ver---------
		.ALIGN
@		.GLOBAL	 sc_write_sdram
		.CODE 32
sc_write_sdram:
	stmfd   r13!,{r4-r6,r14}
    mov r4,r0
...
@-----------------void sc_read_sdram(u16 *s,u16 *d,int num)----not support rumble ver---------
		.ALIGN
@		.GLOBAL	 sc_read_sdram
		.CODE 32
sc_read_sdram:
	stmfd   r13!,{r4-r6,r14}
    mov r4,r0
...
@----------bool sc_rumble_Inserted(void)----------only support rumble ver---------
		.ALIGN
@		.GLOBAL	 sc_rumble_Inserted
		.CODE 32
sc_rumble_Inserted:
	stmfd   r13!,{r14}
    mov r0,#(en_rumble)
	...
	movne	r0,#0
	ldmfd   r13!,{r15}
@----------end sc_rumble_Inserted---------

@------------bool sc_rumble_flash_Erase(u32 flash_address)-----only support rumble ver---------
		.ALIGN
@		.GLOBAL	 sc_rumble_flash_Erase
		.CODE 32
sc_rumble_flash_Erase:
	stmfd   r13!,{r4-r5,r14}
...
flash_Erase_end:
    ...
    moveq r0,#0
	ldmfd   r13!,{r4-r5,r15}
@------------end sc_rumble_flash_Erase--------

@------------bool sc_rumble_flash_write(u32 flash_address,u16 data)-----only support rumble ver---------
		.ALIGN
@		.GLOBAL	 sc_rumble_flash_write
		.CODE 32
sc_rumble_flash_write:
	stmfd   r13!,{r4-r5,r14}
    mov r4,r0
    mov r5,r1
    mov r0,#(en_rumble_user_flash)
